        ...
        <div class="col-md-5">
            <form action="/matakuliah-save" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dosen1" name="dosen1">
                </div>
                <div class="form-group">
                    <label for="dosen2">Dosen 2</label>
                    <input type="text" class="form-control" id="dosen2" name="dosen2">
                </div>
                <div class="form-group">
                    <label for="dosen3">Dosen 3</label>
                    <input type="text" class="form-control" id="dosen3" name="dosen3">
                </div>

                <div class="form-group">
                    <label for="dosen4">Dosen 4</label>
                    <input type="text" class="form-control" id="dosen4" name="dosen4">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jumlahrombongankelas" name="jumlahrombongankelas" required>
                </div>
